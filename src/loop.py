...
class Loop(metaclass=singleton.SingletonMeta):
    ...
    def setup(self):
        ...
        self.board.generate_board(video_widget_size, self.grid_size)
    ...
    def set_size(self):
        ...
        video_widget_width = int(screen_width*self.video_size)
        video_widget_height = int(video_widget_width * 480/640)
        video_widget_size = (video_widget_width, video_widget_height)

        return screen_size, video_widget_size