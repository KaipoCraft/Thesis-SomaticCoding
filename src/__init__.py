...
loop_ = loop.Loop(primary_color, grid_size, marker_dict, aruco_dict, parameters, marker_size, camera_matrix, dist_coeffs, gesture_history_length=gesture_history_length)
loop_.setup()
loop_.run()